...
tags: ""
published: false
title: "2015-05-06-iOS-code-snippets-collection"
---
...
f) UITableViewCell style 分为3种： UITableViewCellStyleDefault (Text label), UITableViewCellStyleSubtitle (Detail), UITableViewCellStyleValue1 (text on left bold, and small text on right with blue), UITableViewCellStyleValue2 (phone book style)
